...
contract Gear is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private cyberWare = [
        "Mechatronic Noodle Core",
        "Optical Enhancer",
        "Synaptic Mood Accelerator",
        "Divine Bionic Joints",
        "Subdermal Armor"
    ];
    ...
    string[] private namePrefixes = [
        "Scumbag", "Y U NO", "Good Guy", "Bad Luck"  
    ];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "MemeBox #', toString(tokenId), '", "description": "randomized adventurer gear", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
